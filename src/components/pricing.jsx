      ...
      <section className={styles.section}>
        <div className={`${styles.card} ${styles.basic}`}>
          ...
          <ul className={styles.ul}>
            <li className={styles.li}>Basic document collaboration</li>
            <li className={styles.li}>2 gb storage</li>
            <li className={styles.li}>Great security and support</li>
          </ul>
        ...
        <div className={`${styles.card} ${styles.pro}`}>
          ...
          <div className={styles.planBox}>
            ...
            <p className={styles.details}>Per user, billed monthly</p>
          ...
          <ul className={styles.ul}>
            <li className={styles.li}>All essential integrations</li>
